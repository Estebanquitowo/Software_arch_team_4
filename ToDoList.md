...
- [x] Make the Rails and MongoDB connection.
...
- [x] A table that shows the top 50 selling books of all time, showing their total sales for the book, total sales for the author, and if the book was in the top 5 selling books in the year of its publication.
- [x] A search window, that lets me input text, and returns a paginated list of books whose summary contains any of the words in the search.
